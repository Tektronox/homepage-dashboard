...
## Sites (Link + Monitoring)
- Mondsichtung https://mondsichtung.com
...
- N23 Bibel: https://drive.proton.me/urls/1ZNVX67F0G#at3ZlGvp0ZWo
- Github https://github.com/Tektronox?tab=repositories

# Internal Stuff
## Tools (Link + Monitoring)
- Git https://git.schelbert.dev/
- Coder https://coder.schelbert.dev/
- Jellyfin https://media.schelbert.dev
